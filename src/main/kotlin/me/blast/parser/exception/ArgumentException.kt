...
sealed class ArgumentException : Exception() {
   ...
   */
  data class Empty(val argument: Argument<*>) : ArgumentException()
   ...
   */
  data class Invalid(val argument: Argument<*>, val input: String) : ArgumentException()
   ...
   */
  data class Insufficient(val argument: Argument<*>, val input: String) : ArgumentException()
   ...
   */
  data class Missing(val arguments: List<Argument<*>>) : ArgumentException()
}